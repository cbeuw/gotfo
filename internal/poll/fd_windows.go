...
import (
	"errors"
	"github.com/cbeuw/gotfo/internal/race"
	"github.com/cbeuw/gotfo/internal/syscall/windows"
	"io"
	"runtime"
	"sync"
	"syscall"
...
//
// GOTFO
func (fd *FD) ConnectEx(ra syscall.Sockaddr, data []byte) error {
	o := &fd.wop
	o.sa = ra
	_, err := wsrv.ExecIO(o, func(o *operation) error {
		if data != nil {
			var bytesSend uint32
			return ConnectExFunc(o.fd.Sysfd, o.sa, &data[0], uint32(len(data)), &bytesSend, &o.o)
		} else {
